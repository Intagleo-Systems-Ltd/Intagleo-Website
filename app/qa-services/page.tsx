            ...
            <div className="grid md:grid-cols-[1fr_1.1fr]">
              ...
              <div className="grid grid-cols-2 grid-rows-2 gap-1.5 p-4 bg-[#0b0c15]">
                <div className="col-span-1 row-span-2 rounded-xl overflow-hidden" style={{ minHeight: "220px" }}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/emp1.png" alt="QA Engineer" className="w-full h-full object-cover object-top" style={{ filter: "grayscale(100%)" }} />
                </div>
                <div className="rounded-xl overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/emp2.png" alt="QA Engineer" className="w-full h-full object-cover object-top" style={{ filter: "grayscale(100%)" }} />
                </div>
                <div className="rounded-xl overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/emp3.png" alt="QA Engineer" className="w-full h-full object-cover object-top" style={{ filter: "grayscale(100%)" }} />
                </div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center text-center p-8 md:p-10">
                <h2 className="text-2xl md:text-3xl font-bold text-white leading-tight mb-4">
                  Untested code is<br />
                  <span className="text-white/40">a liability, not a feature.</span>
                </h2>
                <p className="text-white/45 text-sm leading-relaxed mb-7">
                  Most teams only discover test gaps when something breaks in production.
                  We build the coverage that catches regressions before your users do,
                  integrated directly into your pipeline so quality is never a bottleneck
                  at release time.
                </p>
                <Link
                  href="/contact?type=qa-services"
