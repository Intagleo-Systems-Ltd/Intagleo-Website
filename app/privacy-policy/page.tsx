        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-10 text-white/60 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              <a href="https://www.intagleo.com" className="text-[#3B82F6] hover:text-[#2563EB] transition-colors">www.intagleo.com</a>.
            </p>
            <p className="mt-3">
              If you have any questions about this policy or how we handle your data, please contact our Data Protection Officer
              at <a href="mailto:dpo@intagleo.com" className="text-[#3B82F6] hover:text-[#2563EB] transition-colors">dpo@intagleo.com</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-3 space-y-1.5">
              ...
              <li><span className="text-white/80">Automated technologies:</span> as you interact with our website, we may automatically collect technical data using cookies, server logs, and similar technologies. Please see our <a href="/cookie-policy" className="text-[#3B82F6] hover:text-[#2563EB] transition-colors">Cookie Policy</a> for further details.</li>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              <a href="mailto:dpo@intagleo.com" className="text-[#3B82F6] hover:text-[#2563EB] transition-colors">dpo@intagleo.com</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              <a href="https://www.ico.org.uk" target="_blank" rel="noopener noreferrer" className="text-[#3B82F6] hover:text-[#2563EB] transition-colors">www.ico.org.uk</a>.
            </p>
          </section>
