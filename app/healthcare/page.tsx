...
export default function HealthcarePage() {
  ...
  const vitals = [
    { label: "Heart Rate", value: "72", unit: "bpm", color: "#e8341c" },
      ...
      <section className="relative flex flex-col items-center pt-32 pb-0 px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto pb-16">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link href="/contact?type=healthcare" className="px-6 py-3 rounded-full bg-[#e8341c] text-white text-sm font-semibold hover:bg-[#d42e18] transition-colors">
        ...
        <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-6 items-stretch">
          <div className="relative rounded-2xl overflow-hidden" style={{ minHeight: "480px", background: "#13141a" }}>
            ...
            <div className="absolute inset-0 flex flex-col justify-between p-10">
              ...
              <Link href="/contact?type=healthcare" className="self-start inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#e8341c] text-white text-sm font-semibold hover:bg-[#d42e18] transition-colors cursor-pointer">
      ...
      <section className="relative overflow-hidden py-24 px-6 text-center">
        ...
        <div className="relative z-10 mx-auto max-w-2xl">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-6">
            <Link href="/contact?type=healthcare" className="px-7 py-3 rounded-full bg-[#e8341c] text-white text-sm font-semibold hover:bg-[#d42e18] transition-colors">
              Talk to a healthcare engineer
            </Link>
