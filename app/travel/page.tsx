          ...
          <div className="max-w-3xl mx-auto flex flex-col items-center gap-7">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#3B82F6]/25 bg-[#3B82F6]/[0.07] text-[#3B82F6] text-xs font-medium tracking-wide">
              <svg viewBox="0 0 16 16" fill="none" className="w-3.5 h-3.5 flex-shrink-0" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M2 10l2-6h8l2 6H2z" />
                <path d="M6 10v3M10 10v3M1 13h14" />
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[56px] font-medium customHeading leading-[1.07] tracking-tight">
              Travel tech that moves<br />
              <span className="text-white/35">as fast as your travellers.</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              <Link href="/contact?type=travel" className="px-7 py-3.5 rounded-full btn-shimmer bg-[#3B82F6] text-white text-sm font-semibold hover:bg-[#2563EB] transition-colors">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 pt-1">
              {["Booking Engine Architecture", "GDS & API Integration", "In-Trip Experience Apps", "Dynamic Pricing", "Loyalty Platform"].map((feat) => (
          ...
          <div className="mx-auto max-w-3xl">
            <div className="border-t border-white/[0.07] pt-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              {[
                ...
                { value: "30+",    label: "Travel Platforms Built" },
              ].map((s) => (
                <div key={s.label}>
      ...
      <section style={{ background: "#0a0a0a" }} className="section-padding py-24">
        <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <Link href="/contact?type=travel-review" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full btn-shimmer bg-[#3B82F6] text-white text-sm font-semibold hover:bg-[#2563EB] transition-colors">
        ...
        <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-6 items-stretch">
          <div className="relative rounded-2xl overflow-hidden" style={{ minHeight: "480px", background: "#13141a" }}>
            ...
            <div className="absolute inset-0 flex flex-col justify-between p-10">
              ...
              <Link href="/contact?type=travel" className="self-start inline-flex items-center gap-2 px-5 py-2.5 rounded-full btn-shimmer bg-[#3B82F6] text-white text-sm font-semibold hover:bg-[#2563EB] transition-colors cursor-pointer">
