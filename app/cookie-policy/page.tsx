  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0a]">
      ...
      <main className="relative z-10 section-padding pt-32 pb-24 mx-auto max-w-3xl">
        <h1 className="text-4xl md:text-5xl font-medium customHeading mb-3 tracking-tight">Cookie Policy</h1>
        ...
        <div className="space-y-10 text-white/60 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-medium customHeading mb-3">What Are Cookies?</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-medium customHeading mb-3">How We Use Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-medium customHeading mb-3">Necessary Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-medium customHeading mb-3">Analytics Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-medium customHeading mb-3">Managing Your Cookie Preferences</h2>
          ...
          <section>
            <h2 className="text-xl font-medium customHeading mb-3">Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-medium customHeading mb-3">Contact Us</h2>
