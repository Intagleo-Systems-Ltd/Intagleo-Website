...
export default function CookieConsent() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Cookie icon */}
        <div className="flex-shrink-0 w-9 h-9 rounded-xl bg-[#3B82F6]/10 border border-[#3B82F6]/20 flex items-center justify-center">
          <svg className="w-4 h-4 text-[#3B82F6]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-white/40 text-xs leading-relaxed mt-0.5">
            ...
            <Link href="/cookie-policy" className="text-[#3B82F6]/80 hover:text-[#3B82F6] transition-colors underline underline-offset-2">
              Cookie Policy
            </Link>
            {" "}·{" "}
            <Link href="/privacy-policy" className="text-[#3B82F6]/80 hover:text-[#3B82F6] transition-colors underline underline-offset-2">
              Privacy Policy
            </Link>
          </p>
        </div>
