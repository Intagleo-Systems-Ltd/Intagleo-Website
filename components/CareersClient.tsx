  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <span className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full bg-[#6366f1] group-hover:bg-[#4f46e5] text-white text-sm font-medium transition-colors duration-200">
          View Role
